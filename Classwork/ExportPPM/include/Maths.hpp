 ...
 *  Typically, you should seprate out the interface from the
 *  implementation for: 
 *      - Cleanliness
 *      - Makes code easier to navigate (Can clearly see interface)
 *      - Faster compile times (Changes in headers may often force full recompiles of software)
 *      
 *
 *  @author Mike Shah
 *  @bug No known bugs.
