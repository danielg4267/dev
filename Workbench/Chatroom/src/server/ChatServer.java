...
public class ChatServer {
	...
	private String generatePassword() {
		...
		//TODO: This entire method should be replaced with something more cryptographically sound
	...
	private class ClientHandler extends Thread{
		...
		public void run() {
			...
			try {
				...
				String line;
				//TODO: There needs to be a safer method of reading characters than waiting for \n
				//This is dangerous as hell. A malicious user might connect with their own application
				//or modify the source code to just send super long messages that never contain \n.
