...
*	Texture - this class loads a texture and saves it.
*	I took this straight from a previous lab, as it had 
*	all the functionality I needed. Credit goes to Mike Shah.
*/
...
void Texture::LoadTexture_diff(const std::string filepath){
	// Set member variable
    m_filepath = filepath;
	// Load our actual image data
	// This method loads .ppm files of pixel data
